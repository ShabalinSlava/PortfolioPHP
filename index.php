    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    ...
                    <li class="linkedin"><i class="fa fa-linkedin"></i><a href="<?= $aboutData['linkedin'] ?>" target="_blank"><?= $aboutData['linkedin'] ?></a></li>
        ...
        <div class="main-wrapper">
            ...
            <section class="section projects-section">
                ...
                <div class="item">
                    <span class="project-title"><a href="<?=$project['company']?>"><?=$project['company']?></a></span> - <span class="project-tagline"><?=$project['description']?></span>   
                </div><!--//item-->
                <?}?>
            </section><!--//section-->
